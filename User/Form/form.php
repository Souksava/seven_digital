                ...
                <tr>
                    ...
                    <td>
                        <a href="../../image/logo.png" target="_blank">
                            <img src="../../image/logo.png" class="img-circle elevation-2" alt="../../image/product.png" width="30px">
                        </a>
                    </td>
                    <td>12345678</td>
                    <td>FUJI</td>
                ...
                <div class="modal-body">
                    <div class="row" align="left">
                        <div class="col-md-12 col-sm-6 form-control2">
                            ...
                            <div class="col-md-12 col-sm-6 form-control2">
                                <img src="../../image/product.png" alt="../../image/product.png" id="output2" width="100%" height="250">
                            </div>
                        ...
                        <div class="col-md-12 col-sm-6 form-control2">
                            <label>ຈຳນວນ</label>
                            <input type="number" min="1" name="num_update" id="num_update" placeholder="1">
                            <i class="fas fa-check-circle "></i>
                            <i class="fas fa-exclamation-circle "></i>
                            <small class="">Error message</small>
                        </div>
