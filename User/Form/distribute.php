         ...
         <div class="row">
             <div class="col-md-8">
                 ...
                 <div align="right">
                     ...
                     <div class="col-md-12">
                         <br><h4 style="color: #CE3131;"> 9 ສິນຄ້າ</h4> 
                     </div>
                 </div>
             </div>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-12 form-control2">
                                             ...
                                             <div class="col-md-12" align="center">
                                                    <button type="button" name="btnAdd" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModal2">ດຳເນີນການເບີກສິນຄ້າ</button>
